...
class bien{
		...
		function consultar(){
			...
			if(!$this->nombre_bien==NULL || !$this->nombre_bien==""){
				...
				$SQL="SELECT * FROM bien as b JOIN datos_bien as db on b.id_bien=db.id_bien JOIN concepto_de_movimiento as cm on b.id_concepto=cm.id_concepto WHERE db.nombre_bien LIKE '$this->nombre_bien' ORDER BY db.id_bien";								
