...
function consultar(){
   if(document.getElementById('nombreBien').value!=""){
      $.ajax
      ({
         type: "POST",url:"../C/cConsultarBienComodato.php",
         ...
         success:function(msg)         
         {
            ...
            var respuesta='<tr><th>Resultado Nº</th><th>Bienes Registrados</th><th>Serial</th><th>Sección</th><th>Código de Barras</th></tr>';
            var contador=-1;
            var contador1=0;
            $(msg).each(function(index, value)
            {
               ...
               respuesta+="value="
               respuesta+="\'";
               respuesta+=msg[index]["descipcion_bien"];
               respuesta+="\'"+">";
               respuesta+='<input type="hidden" id=';
