	...
	?>	
	 <div class="main">
		<div class="class-form-1" id="divConsulta" align="center">
			<h1 class="class-h1">Generar Acta de Control Perceptivo</h1>
			<form action="ConsultaActa.php" method="POST" name="formu1" class="formu" id="formulario1">
				<table>
					<tr>
						...
						<td>
							<input class="text-nombre" maxlength="10" type="text" required="required" name="idBien" id="idBien_" autofocus title="Número identificador del bien" autocomplete="off" pattern="[0-9]+" onkeyup="return validarEspacio(event,this);" onkeypress="return validarEspacio(event,this);" >			
						</td>
						<td>
