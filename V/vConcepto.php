	 ...
	 <div class="main">
		<div class="class-form-1" id="divConsulta" align="center">
			...
			<form action="../C/cConcepto.php" method="POST" name="formu1" class="formu" id="formulario1">
				...
				<h3><img src="images/help.png" alt="Information" height="50" width="50"/>Este Formulario será utilizado para gestionar los Conceptos de los Bienes Muebles</h3><br>
				<table>
					<tr>
						<td>							
				...
				<h2>Catálogo de Conceptos registrados</h2><br>
