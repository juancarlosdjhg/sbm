...
// Some data
$datay=array(5000,12000,0,9500,1,1,1,1,1,1,56,10000);
...
$graph->title->Set(utf8_decode('Relación montos de Incorporaciones y Desincorporaciones'));
$graph->title->SetFont(FF_FONT2,FS_BOLD);
$graph->xaxis->title->Set(utf8_decode('Año 2015'));
$graph->xaxis->title->SetFont(FF_FONT2,FS_BOLD);

// Create a bar pot
$bplot = new BarPlot($datay);
$bplot->SetFillColor('#09A7F0');
$bplot->SetWidth(0.5);
$bplot->SetShadow();
