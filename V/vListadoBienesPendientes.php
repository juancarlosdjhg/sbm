	...
	?>	
	 <div class="main">
		<div class="class-form-1" id="divConsulta" align="center">
			<h1 class="class-h1">Bienes Pendientes por Revisión</h1>
			<form action="../C/cBien.php" method="POST" name="formu1" class="formu" id="formulario1" enctype="multipart/form-data">
				<table>
					...
					<td>
						<input class="text" type="search" name="nombreBien" id="nombreBien" autocomplete="off" pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+" onkeyup="return validarEspacio(event,this);" onkeypress="return validarEspacio(event,this);" onchange="javascript:consultar();">			
					</td>
					<td>							
				...
				<table class="tablaResultados" id="tablaResultados1">					
					...
					$llenarBien = new Bien;
					$llenarBien->llenarTablaBienesPendientes();
					?>
				</table>
					</div>	
