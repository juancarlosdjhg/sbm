...
<head>
	<title>SBM</title>
		...
		<script type="text/javascript" src="vListadoBienesComodatoAjax.js"></script>
</head>
	<body>
	<?php 
	...
	?>	
	 <div class="main">
		<div class="class-form-1" id="divConsulta" align="center">
			<h1 class="class-h1">Bienes en Comodato</h1>
			<form action="../C/cBien.php" method="POST" name="formu1" class="formu" id="formulario1" enctype="multipart/form-data">
				...
				<table class="tablaResultados" id="tablaResultados1">					
					<?php 
					$llenarBien = new Bien;
					$llenarBien->llenarTablaBienesComodato();
					?>
				</table>
					</div>	
