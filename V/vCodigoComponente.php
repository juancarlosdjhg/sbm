	...
	?>	
	 <div class="main">
		<div class="class-form-1" id="divConsulta" align="center">
			...
			<form action="../C/cGestionarComponente.php" method="POST" name="formu1" class="formu" id="formulario1">
				<table>
					<tr>
						<td>							
							<label for="nombreCargo"><h2>Identificador del Bien al cual desea asociar Componente(s):</h2></label>
						</td>
						<td>
						...
						<td>
							<input name="buscar" id="buscar" class="mvc-submit" value="Consultar" type="submit" target="popup">
						</td>
					</tr>
