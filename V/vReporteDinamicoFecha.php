...
$desde3=$_SESSION['desde'];
$desde2=explode('-', $desde3, 3);
$desde=$desde2[2]."-".$desde2[1]."-".$desde2[0];

$hasta3=$_SESSION['hasta'];
$hasta2=explode('-', $hasta3, 3);
  ...
  $this->SetFont('Arial','B',12); 
    $width=252/$cantidadTablas2;
     $this->Image('images/head.jpg',46,0,200,26); 
      $this->Text(94,40,"Reporte de Bienes Registrados en el Sistema"); 
       $this->SetFont('Arial','B',10); 
       $this->Text(95,45,"Rango de fechas: Desde ".$desde." hasta ".$hasta); 
      }
    ...
    $width=186/$cantidadTablas2; 
     $this->Image('images/head.jpg',12,0,200,26);
      $this->Text(60,40,"Reporte de Bienes Registrados en el Sistema"); 
       $this->SetFont('Arial','B',10); 
      $this->Text(61,45,"Rango de fechas: Desde ".$desde." hasta ".$hasta); 
    }  
              ...
              $this->Cell($width,5,$fecha,1,0, 'C', $color);
               ...
               if($marca1==1){
                ...
                $this->Cell($width,5,$subgrupo,1,0, 'L', $color);}
                 ...
                 if($valor1==1){
                 $this->Cell($width,5,$valor." BsF",1,0, 'R', $color);}
